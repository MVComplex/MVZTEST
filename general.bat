...
rem ------------------------------------------------------------
rem 3) Запуск winws
rem    ВАЖНО: без start, чтобы не вылезало отдельное окно и
rem    чтобы bat держал процесс (удобно для MVZ)
rem ------------------------------------------------------------
